...
<%@ page import="model.servicosDAO"%>
<%@ page import="java.util.ArrayList"%>
<%
	@SuppressWarnings("unchecked")
ArrayList<servicos> servicos = (ArrayList<servicos>) request.getAttribute("servicos");
%>
             	...
             	<table class="w-full whitespace-no-wrap">
                  ...
                  <%for (int i = 0; i < servicos.size(); i++) { %>
                    ...
                    <td class="px-4 py-3 text-sm">
                     <%=servicos.get(i).getDescricao_servico() %>
                      </td>
                      
                    <td class="px-4 py-3 text-sm">
                      <%=servicos.get(i).getTempo_servico()%>
                      </td>
                      
                      <td class="px-4 py-3 text-sm">
                      R$<%=servicos.get(i).getPreco_servico()%>
                      </td>
