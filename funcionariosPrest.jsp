...
<%@ page import="model.funcionariosDAO"%>
...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="pt-br">
  <head>
    ...
    <title>Agendout | Funcionários</title>
             	...
             	<table class="w-full whitespace-no-wrap">
                  ...
                  <%for (int i = 0; i < funcionarios.size(); i++) { %>
                    ...
                    <td class="px-4 py-3 text-sm">
                      <%=funcionarios.get(i).getNome_funcionario() %>
                      </td>
                      
                    <td class="px-4 py-3 text-sm">
                      <%=funcionarios.get(i).getEmail_funcionario()%>
                      </td>
                      
                      <td class="px-4 py-3 text-sm">
                      <%=funcionarios.get(i).getSenha_funcionario()%>
                      </td>
